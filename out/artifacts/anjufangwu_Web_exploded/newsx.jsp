        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a
                        href='javascript:;'>主页</a> > <a href='javascript:;'>新闻动态</a> > </span></div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="main col-md-9 inner-left" role="main">
                    <div class="blog-post blog-post-wrap">
                        ...
                        <small class="text-center bp-desc"><i class="fa fa-tag"></i> &nbsp;<a
                                href="javascript:;">新闻动态</a> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<i
                                class="fa fa-calendar"></i> &nbsp;${news.pubtime }</small>
