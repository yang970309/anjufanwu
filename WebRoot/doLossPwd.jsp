        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a
                        href='javascript:;'>主页</a> > <a href='javascript:;'>忘记密码</a></span></div>
            </div>
        </div>
    </div>
                            ...
                            <form class="add-msg-form" action="login.do" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="cf-column col-md-12">
                                        <label>用户名：</label>
                                        <input name="uname" id="uname_loss" type="text" placeholder="请输入用户名"
                                               onblur="checkLossPwd();"/>
                                    ...
                                    <div class="cf-column col-md-12" id="showQuestion" style="display: none">
                                        <label>密保答案：</label>
                                        <input name="question" id="miBaoQuestion" type="text" placeholder="请输入密保答案"
                                               onblur="checkMiBao();"/>
