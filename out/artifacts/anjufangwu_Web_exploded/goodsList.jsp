...
<div id="container">
    ...
    <div class="breadcrumb-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-4 bcid-cat">设计师作品信息</div>
                                    ...
                                    <div class="portfolio-item isotope-item col-sm-4 col-xs-6">
                                        <article>
                                            <figure class="glass-animation">
                                                <a class="swipebox" href="showGoodsx.do?id=${u.id }"> <span
                                                    ...
                                                    <img class="img-responsive" src="./upload/${u.img }"
                                                         alt="${u.name }" style="width:262px;height:262px;"/> </a>
                                            </figure>
                                            <h5 class="item-title"><a href="showGoodsx.do?id=${u.id }"
                                                                      title="${u.name }">设计师作品名称：${u.name }</a></h5>
                                            <h5 class="item-title"><a href="showGoodsx.do?id=${u.id }"
                                                                      title="${u.name }">分类：
                                            ...
                                            <h5 class="item-title"><a href="showGoodsx.do?id=${u.id }"
                                                                      title="${u.name }">累计预约量：${u.xnum }</a></h5>
                ...
                <aside class="sidebar col-md-3 inner-right" role="complementary">
                    <section class="widget side-search">
                        ...
                        <form class="searchform" id="searchform" name="formsearch" method="post"
                              action="selectGoodsList.do">
                            <input type="hidden" name="kwtype" value="0"/>
                            <div class="sform-div">
                                <input type="text" name="name" placeholder="输入设计师作品名称" id="s"/>
