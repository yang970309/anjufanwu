                            ...
                            <div class="row portfolio-3-columns isotope-x clearfix">
                                ...
                                <table class="layui-table table table-bordered table-hover" lay-filter="mylist"
                                    ...
                                    <tr>
                                        ...
                                        <th lay-data="{field:'ly',align:'center', minWidth:100}">订单数量</th>
                                    ...
                                    <c:forEach items="${list }" var="o">
                                        ...
                                        <tr>
                                            ...
                                            <td>${o.status }</td>
                                            <td>
                                                <a href="doAddpj.do?id=${o.id }" class="btn btn-info">查看</a>
                                                <c:if test="${o.status=='已支付' }">
                                                <a href="doAddpj2_1.do?id=${o.id }" class="btn btn-info">评价</a>
                                                </c:if>
                                                <a href="deleteForderF.do?id=${o.id }" class="btn btn-info">删除</a>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
