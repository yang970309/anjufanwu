...
<form class="layui-form column-content-detail" method="post" action="updateNews.do" enctype="multipart/form-data">
    <div class="layui-tab">
            ...
            <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="name" value="${news.name}" required lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea id="editor_id" id="note" name="note"
                                  style="width:500px;height:400px;">${news.note}</textarea>
                    </div>
                </div>
            </div>
        </div>
