...
<div class="wrap-container clearfix">
    <div class="column-content-detail">
        <form class="layui-form" action="searchNewsList.do" method="post">
            <div class="layui-form-item">
                <div class="layui-inline tool-btn">
                    <!-- 								<button class="layui-btn layui-btn-small layui-btn-normal addBtn" data-url="news_add.jsp"><i class="layui-icon">&#xe654;</i></button>
                ...
                <div class="layui-inline">
                    <input type="text" placeholder="请输入搜索名称" name="name" autocomplete="off" class="layui-input">
                </div>
        ...
        <div class="layui-form" id="table-list">
            <table class="layui-table" lay-filter="mylist" lay-size="lg">
                ...
                <tr>
                    ...
                    <th lay-data="{field:'yx', align:'center',minWidth:270}">名称</th>
                ...
                <c:forEach items="${list }" var="u" varStatus="num">
                    <tr>
                        ...
                        <td><a class="layui-btn layui-btn-xs" href="doUpdateNews.do?id=${u.id }">修改</a>
                            <a class="layui-btn layui-btn-danger layui-btn-xs color2" onclick="return del(1,1,1)"
                               href="deleteNews.do?id=${u.id }">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        layer.open({
            ...
            // time: 2000, //2秒后自动关闭
            anim: 5,//动画
            content: ['news_add.jsp', 'no'], //iframe的url，no代表不显示滚动条
        });
