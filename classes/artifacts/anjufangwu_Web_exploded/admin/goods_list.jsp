...
<div class="wrap-container clearfix">
    <div class="column-content-detail">
        <form class="layui-form" method="post" action="searchGoodsList.do">
        ...
        <div class="layui-form" id="table-list">
            ...
            <table class="layui-table" lay-filter="mylist" lay-size="lg">
                ...
                <tr>
                    ...
                    <th lay-data="{field:'zy',align:'center', minWidth:100}">预约次数</th>
                    ...
                    <tr>
                        ...
                        <td><a class="layui-btn layui-btn-xs" href="doUpdateGoods.do?id=${u.id }">修改</a>
                            <a class="layui-btn layui-btn-danger layui-btn-xs color2" onclick="return del(1,1,1)"
                               href="deleteGoods.do?id=${u.id }">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        layer.open({
            ...
            // time: 2000, //2秒后自动关闭
            anim: 5,//动画
            content: ['doAddGoods.do', 'yes'], //iframe的url，no代表不显示滚动条
        });
