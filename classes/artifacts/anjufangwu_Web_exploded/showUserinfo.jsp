                    ...
                    <div class="about-page-wrap">
                        <div id="contact-wrap">
                            ...
                            <form class="add-msg-form" action="addShowInfo.do" onsubmit="return check();" method="post"
                                ...
                                <div class="row">
                                    <div class="cf-column col-md-12"><label>用户名：</label>
                                        <input id="username" type="text" value="${user.uname }" placeholder="登录名"
                                               readonly="readonly" onblur="return checkuname00()"/>
                                        <input type="hidden" name="id" value="${user.id }">
                                        <span id='checku' class="spanInit"></span>
                                    </div>
                                    <div class="cf-column col-md-12"><label>用户余额：</label>
                                        <input name="money" value="${user.money }" readonly="readonly"/>
                                    </div>
                                    <div class="cf-column col-md-12"><label>真实姓名：</label>
                                        <input name="tname" value="${user.tname }" type="text" placeholder="真实姓名"
                                    ...
                                    <div class="cf-column col-md-12"><label>密码：</label>
                                        <input name="pwd" id="txtPwd" type="password" value="${user.pwd }"
                                               placeholder="密码" onblur="return checkpwd()"/>
                                        <span id='prompt_pwd' class="spanInit"></span>
                                    </div>

                                    <div class="cf-column col-md-12"><label>性别：</label>
                                        <select name="sex">
                                    ...
                                    <div class="cf-column col-md-12"><label>电话：</label>
                                        <input name="tel" id="txtPhone" value="${user.tel }" type="text"
                                               placeholder="电话/手机" id="txtPhone" onblur="return checktel()"/>
                                        <span id='prompt_phone' class="spanInit"></span>
                                    </div>
                                    <div class="cf-column col-md-12"><label>邮箱：</label>
                                        <input name="email" id="" type="text" value="${user.email }" placeholder="请输入邮箱"
                                               required="required"/>
                                        <span id='' class="spanInit"></span>
                                    </div>
                                    <div class="cf-column col-md-12"><label>地址：</label>
                                        <input name="address" value="${user.address }" id="address" type="text"
                                               placeholder="地址"/>
                                    </div>
                                    <div class="cf-column col-md-12"><label>密保问题：</label>
                                        <input name="mbanswer" id="" value="${user.mbanswer }" type="text"
                                               placeholder="密保问题" required="required"/>
                                    </div>
                                    <div class="cf-column col-md-12"><label>密保答案：</label>
                                        <input name="question" id="" value="${user.question }" type="text"
                                               placeholder="密保答案" required="required"/>
                                    </div>

                                    <div class="cf-column col-md-12 submit-column">
                                        <button type="submit" id="submit-btn" class="submit-button"
                                                onclick="return checkAll()">修改
                                        </button>
                                    </div>
                                </div>
                            </form>
