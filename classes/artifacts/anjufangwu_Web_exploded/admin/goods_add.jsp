...
<form class="layui-form column-content-detail" method="post" action="addGoods.do" enctype="multipart/form-data">
    <div class="layui-tab">
        <ul class="layui-tab-title">
            <li class="layui-this">添加设计师作品</li>
        </ul>
            ...
            <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" required="required" placeholder="请输入名称" autocomplete="off"
                               class="layui-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="number" name="price" min="1" required lay-verify="required" placeholder="请输入价格"
