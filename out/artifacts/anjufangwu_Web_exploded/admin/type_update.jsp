...
<head>
    ...
    <script type="text/javascript" src="js/typeSave.js"></script>
            ...
            <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="${ftype.name }" name="name" id="name" onblur="checkUpdateName();"
                               required lay-verify="required" autocomplete="off" class="layui-input">
                        <input type="hidden" id="tid" value="${ftype.id }" name="id"/>
